...
func (cc *consulClientConn) ReportError(err error) {
	panic("implement me")
}

func (cc *consulClientConn) ParseServiceConfig(serviceConfigJSON string) *serviceconfig.ParseResult {
	panic("implement me")
}
